...
class QuicSession {
   ...
   * supports stream callbacks (e.g. HTTP/3) - an onheaders callback that
   * exposes every incoming stream to the application.
   * @returns {boolean}
   */
  #hasStreamConsumer() {
  ...
  [kNewStream](handle, direction) {
    ...
    // supports stream callbacks (e.g. HTTP/3), an onheaders callback -
